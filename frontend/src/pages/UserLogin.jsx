...
const UserLogin = () => {
  ...
  return (
    <div className='p-7 flex flex-col h-screen justify-between'>
        ...
        <div>
            <Link to='/captain-login' className='bg-[#10b461] flex item-center justify-center text-white font-semibold mb-5 rounded px-4 py-2 w-full text-lg placeholder:text-base'>
